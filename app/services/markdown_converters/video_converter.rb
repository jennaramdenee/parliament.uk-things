...
module MarkdownConverter
  class VideoConverter
    class << self
      ...
      def create_video_html(id, start_time, end_time)
        "<iframe src='https://videoplayback.parliamentlive.tv/Player/Index/#{id}?in=1900-01-01T#{encode_video_times(start_time)}%2B01%3A00&amp;out=1900-01-01T#{encode_video_times(end_time)}2B01%3A00&amp;audioOnly=False&amp;autoStart=False&amp;statsEnabled=False' id='UKPPlayer' name='UKPPlayer' title='UK Parliament Player' seamless='seamless' frameborder='0' allowfullscreen style='width:100%;height:100%;'></iframe>"
      end
