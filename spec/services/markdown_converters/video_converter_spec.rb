...
RSpec.describe MarkdownConverter::VideoConverter do
  ...
  context '#extract_video_links' do
    it 'can extract video links' do
      expect(MarkdownConverter::VideoConverter.send(:extract_video_links, original_article.article_body)).to eq([["[video id:114c33a1-f412-44a8-b5c1-f1822b895f46 start:06:50:00 end:07:00:00]", "114c33a1-f412-44a8-b5c1-f1822b895f46", " start:06:50:00 end:07:00:00", "06:50:00", "07:00:00"], ["[video id:bf2334ce-e87f-4224-9a81-9a0e9886f19b]", "bf2334ce-e87f-4224-9a81-9a0e9886f19b", nil, nil, nil]])
    end
  end
